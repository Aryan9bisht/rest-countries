...
function DarkModeButton() {
  ...
  React.useEffect(() => {
    document.body.style.backgroundColor = isDarkMode ?"rgb(33, 45, 55)" : "#fff";
...
{isDarkMode ? (
  <>
   <Brightness7Icon /><Typography> &nbsp; Dark Mode   </Typography> 
  </>
) : (
  <>
    <Brightness4Icon /><Typography>&nbsp; Light Mode   </Typography>  
  </>
)}
